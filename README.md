![Earl](https://raw.githubusercontent.com/l2beat/@hishprorg/placeat-error/master/gh-cover.png)
...
<p align="center">
  ...
  <p align="center">
    <img alt="Build status" src="https://github.com/hishprorg/placeat-error/workflows/CI/badge.svg">
    <a href="https://github.com/hishprorg/placeat-error/tree/master/LICENSE"><img alt="Software License" src="https://img.shields.io/badge/license-MIT-brightgreen.svg"></a>
  </p>
</p>
...
```sh
npm install --save-dev @hishprorg/placeat-error
```

## Example

```typescript
import { expect } from '@hishprorg/placeat-error'
...
- [Getting started](https://@hishprorg/placeat-error.fun/introduction/getting-started.html)
- [API reference](https://@hishprorg/placeat-error.fun/api/api-reference.html)
